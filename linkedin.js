...
linkedinGroup = 'https://www.linkedin.com/groups?viewMembers=&gid=70714&sik=1426161415287'
...
for (i = 1; i <= 25; i++) {
	for (j = 1; j <= 20; j++) {
		macro += 'EVENT TYPE=CLICK SELECTOR="#content>UL>LI:nth-of-type(' + j + ')>SPAN>STRONG>A>IMG" BUTTON=0 MODIFIERS="meta"' + '\n';
		macro += 'WAIT SECONDS=2' + '\n';
		
		macro += 'TAB T=2' + '\n';
		
		macro += 'EVENT TYPE=CLICK SELECTOR="#tc-actions-send-message" BUTTON=0 MODIFIERS="meta"' + '\n';
	...
	macro += 'WAIT SECONDS=4' + '\n';
	macro += 'EVENT TYPE=CLICK SELECTOR=".paginate>A:nth-of-type(' + i + ')" BUTTON=0 MODIFIERS="meta"' + '\n';
	macro += 'TAB CLOSE' + '\n';
}
...
iimDisplay("iMacro is now running. Let's hack growth. -M-");
